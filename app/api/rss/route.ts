...
export async function GET(): Promise<Response> {
    const rss = new RSS({
        ...
        image_url: 'https://static.karim.cloud/e3f07d61-ee0e-457d-ac76-ddd0377b824d%2Fkarim-ink-1.jpeg',
    })
    ...
    const pageObjects = posts.filter((post): post is PageObjectResponse => !!post)
